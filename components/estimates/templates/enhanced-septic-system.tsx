...
import { Trash2, Calculator, Clock, Package, SaveIcon, ReceiptText } from "lucide-react";
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table";
import RateSelector, { SavedRate } from "../rate-selector";
import { LineItem } from "../estimate-form";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/components/ui/tooltip";

export default function EnhancedSepticSystemTemplate() {
	// State for the estimate
	const [projectName, setProjectName] = useState("Enhanced Septic System Installation");
	...
	useEffect(() => {
		if (selectedRate) {
			...
			// Create template items for enhanced septic system
			const templateItems: LineItem[] = [
				...
				},
				{
					...
					description: "Labor to install septic tank",
					type: "labor",
					quantity: 1,
					hours: 6,
					price: hourlyRate,
					totalPrice: hourlyRate * 6,
				},
				{
					id: crypto.randomUUID(),
					name: "Drain Field Installation",
					description: "Labor to install enhanced drain field system",
					type: "labor",
					quantity: 1,
					hours: 12,
					price: hourlyRate,
					totalPrice: hourlyRate * 12,
				},
				{
					id: crypto.randomUUID(),
					name: "Advanced Treatment Unit Installation",
					description: "Labor to install advanced treatment components",
					type: "labor",
					quantity: 1,
					hours: 5,
					price: hourlyRate,
					totalPrice: hourlyRate * 5,
				},
				{
					id: crypto.randomUUID(),
				...
				},
				{
					...
					hours: 3,
					price: hourlyRate,
					totalPrice: hourlyRate * 3,
				},
				// Materials with base prices (without markup)
				{
					id: crypto.randomUUID(),
					name: "Enhanced Septic Tank",
					description: "High-capacity multi-chamber septic tank",
					type: "material",
					quantity: 1,
					price: 3500, // Base cost
					totalPrice: applyMaterialMarkup(3500, materialMarkup), // With markup
				},
				{
					id: crypto.randomUUID(),
					name: "Advanced Treatment Unit",
					description: "Aerobic treatment system with controls",
					type: "material",
					quantity: 1,
					price: 5200, // Base cost
					totalPrice: applyMaterialMarkup(5200, materialMarkup), // With markup
				},
				{
					id: crypto.randomUUID(),
					name: "Enhanced Drain Field System",
					description: "Premium drain field materials and components",
					type: "material",
					quantity: 1,
					price: 4800, // Base cost
					totalPrice: applyMaterialMarkup(4800, materialMarkup), // With markup
				},
				{
					id: crypto.randomUUID(),
					name: "Electrical Components",
					description: "Control panels, wiring, sensors",
					type: "material",
					quantity: 1,
				...
				{
					id: crypto.randomUUID(),
					name: "Piping and Fittings",
					description: "High-grade pipes and connectors",
					type: "material",
					quantity: 1,
					price: 1800, // Base cost
					totalPrice: applyMaterialMarkup(1800, materialMarkup), // With markup
				},
				{
					id: crypto.randomUUID(),
					name: "Backfill Materials",
					description: "Specialized backfill and filtration media",
					type: "material",
					quantity: 1,
					price: 1500, // Base cost
					totalPrice: applyMaterialMarkup(1500, materialMarkup), // With markup
				},
				{
					id: crypto.randomUUID(),
					name: "Permit Fees",
					...
					quantity: 1,
					price: 950, // Base cost
					totalPrice: applyMaterialMarkup(950, materialMarkup), // With markup
				},
			];
	...
	const saveEstimate = () => {
		...
		const newEstimate = {
			...
			template: "enhanced-septic-system",
		};
		...
		<div className="space-y-6">
			<Card>
				<CardHeader className="flex flex-row items-center">
					...
					<div>
						<CardTitle>Enhanced Septic System Installation</CardTitle>
						<CardDescription>Estimate template for advanced septic systems with treatment units</CardDescription>
					</div>
				</CardHeader>
