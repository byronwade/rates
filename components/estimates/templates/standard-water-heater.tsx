...
export default function StandardWaterHeaterTemplate() {
	// State for the estimate
	const [projectName, setProjectName] = useState("Standard Water Heater Installation");
	...
	useEffect(() => {
		if (selectedRate) {
			...
			// Create template items for standard water heater
			const templateItems: LineItem[] = [
				...
				// Materials with base prices (without markup)
				{
					...
					quantity: 1,
					price: 650, // Base cost
					totalPrice: applyMaterialMarkup(650, materialMarkup), // With markup
				},
				{
					id: crypto.randomUUID(),
				...
				},
				{
					...
					quantity: 2,
					price: 15, // Base cost
					totalPrice: applyMaterialMarkup(15 * 2, materialMarkup), // With markup
				},
				{
					id: crypto.randomUUID(),
					...
					quantity: 1,
					price: 35, // Base cost
					totalPrice: applyMaterialMarkup(35, materialMarkup), // With markup
				},
				{
					id: crypto.randomUUID(),
				...
				},
				{
					...
					quantity: 1,
					price: 90, // Base cost
					totalPrice: applyMaterialMarkup(90, materialMarkup), // With markup
				},
			];
	...
	const saveEstimate = () => {
		...
		const newEstimate = {
			...
			template: "standard-water-heater",
		};
		...
		<div className="space-y-6">
			<Card>
				<CardHeader className="flex flex-row items-center">
					...
					<div>
						<CardTitle>Standard Water Heater Installation</CardTitle>
						<CardDescription>Estimate template with predefined labor and materials</CardDescription>
					</div>
				</CardHeader>
